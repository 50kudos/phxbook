defmodule Phxbook.VideoControllerTest do
  ...
  test "requires all user authentication on all actions", %{conn: conn} do
    Enum.each([
  ...
  @tag login_as: "max"
  test "authorizes action against access by other users", %{user: owner, conn: conn} do
